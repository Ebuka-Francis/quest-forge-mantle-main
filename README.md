...
Yield Quest is built to educate users about Mantle Network, a modular Layer 2 blockchain solution.
...
🔧 How It Works
User Flow
Connect Wallet - Link Web3 wallet (MetaMask, WalletConnect, etc.)
Choose Quest - Select Chess or Tower Defense game
Join Quest - Approve and start playing immediately
Play & Learn - Every action displays Mantle Network education
Earn XP - Gain experience points for gameplay achievements
Level Up - Progress through levels and unlock rewards
Track Progress - View completed games on Journey page
XP Point System
Action	XP Reward
